...
function confettiFalls() {
  ...
  document.addEventListener("keydown", function (event) {
    pointer = konami[pointer] === event ? pointer + 1 : +(event === konami[0]);
...
const ConfettiComponent = () => {
  ...
  const [startConfetti, setRunConfetti] = useState(false);
  ...
  return (
    <div>
      {gameResult === "playerWins" ? startConfetti && confettiFalls() : ""}
    </div>
  );
};
